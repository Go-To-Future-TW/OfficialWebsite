    ...
    <footer className="bg-black py-8 mt-auto border-t border-white/10">
      <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-neutral-500">
        ...
        <div className="flex items-center gap-4">
          {/* Facebook */}
          {/* <a href="#" target="_blank" rel="noopener noreferrer" className="text-neutral-500 hover:text-neutral-300 transition">
          ...
          {/* Instagram */}
          <a href="https://www.instagram.com/go_to_future.tw/" target="_blank" rel="noopener noreferrer" className="text-neutral-500 hover:text-neutral-300 transition">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              <title>ig</title>
