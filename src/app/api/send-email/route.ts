          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="margin:0 0 24px;font-size:15px;color:#555;line-height:1.8;">
                感謝您使用我們的專案估價服務！我們已收到您的需求，以下是您提交的摘要：
              </p>
              ...
              <p style="margin:0 0 12px;font-size:15px;color:#555;line-height:1.8;">
                我們的團隊將於 <strong>24 小時內</strong> 與您聯繫，針對您的需求提供更詳細的規劃建議。
              </p>
              <p style="margin:0 0 24px;font-size:15px;color:#555;line-height:1.8;">
                若有任何問題，歡迎隨時回覆此信件與我們聯繫。
              </p>

              <p style="margin:0;font-size:14px;color:#999;">
                Go To Future Development 團隊 敬上
              </p>
            </td>
          </tr>
          <!-- Footer -->
          <tr>
            <td style="background:#fafafa;padding:20px 40px;text-align:center;border-top:1px solid #eee;">
              <p style="margin:0;font-size:12px;color:#bbb;">
                ...
                © ${new Date().getFullYear()} Go To Future Development
              </p>
            </td>
          </tr>
        </table>
